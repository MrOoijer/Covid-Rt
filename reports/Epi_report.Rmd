---
title: "EpiEstim for $R_e(t)$ in the  NL"
...
`r 100*round(1-sqrt(mean(((Epi_Rt_DOO$R-Epi_Rt$R)[-(1:250)])^2)), 4)` percent on the recent half of the data. But also note that the EpiEstim approach in this case is a simulation so numbers will differ a bit each time you run this file. 
