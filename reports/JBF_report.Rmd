...
On 2021-07-25 I have rewritten the complete JBF algorithm and given it a more solid theoretical base. That version is now used here.
...
pretty_density((JBF_ts$cases- rivm_ts$cases), main="(JBF-RIVM) distribution (plus the 95% values area")    
