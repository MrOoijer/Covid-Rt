...
Let's skip the details of how the RIVM changed the processing the last 1.5 years and let's just take a period where everythins was more or less stable, Say from 2020-08-01 to 2021-06-25. So for that period we compare the JBF method with the RIVM one. The measure is `1-rmse`and the density distribution shows that the avg error is only .01 - smaller than any other error we can imagine in this process. 
...
pretty_density(abs(JBF_ts$cases- rivm_ts$cases), main="JBF-RIVM")    
